...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                <h1 class="col-xs-12 text-center">היסטורית ביקורים</h1>
...
<br-->
            <div class="table-responsive">
                <table class="table1 table table-hover table-dark table-fixed" style="margin-bottom: 50px;" id="table1Id"> 
                    <tr> 
                ...
                $.ajax({
                    ...
                    success:function(data)
                    {
                        ...
                        $.map(data, function(model, key) {
                            if (model.employeevisit_empnumber===pparam2){ 
...
//console.log(itemn1+","+itemn2+","+empIdNum+","+empnumber+":"+request.term)
